...
export function LineFloatingButton({ ariaLabel, label }: LineFloatingButtonProps) {
  return (
    <a
      href={SITE_LINE_URL}
      target="_blank"
    ...
    >
      ...
      <span className="max-w-[9.5rem] text-pretty leading-tight sm:max-w-none">{label}</span>
    </a>
  );
}
