  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="grid gap-6 rounded-[2rem] border border-white/70 bg-white/55 p-3 shadow-[0_30px_80px_-40px_rgba(190,24,93,0.45)] backdrop-blur-sm lg:grid-cols-[1.05fr_1fr] lg:gap-0 lg:p-5">
          <div className="rounded-[1.5rem] bg-gradient-to-br from-white/85 to-rose-50/75 p-6 sm:p-8 lg:p-10">
            ...
            <h1 className="font-display mt-5 text-3xl font-semibold leading-[1.15] tracking-tight text-rose-950 sm:text-4xl lg:text-[2.8rem]">
              {HERO_TITLE_LINES[0]}
              <br />
              {HERO_TITLE_LINES[1]}
              <br />
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-rose-600 to-pink-600 px-7 py-3 text-sm font-semibold text-white shadow-lg shadow-rose-300/40 transition hover:brightness-110"
              >
                สอบถามเพิ่มเติม
              </a>
              <Link
                href="/our-course"
                className="inline-flex items-center justify-center rounded-full border border-rose-200 bg-white px-7 py-3 text-sm font-semibold text-rose-800 transition hover:border-rose-300 hover:bg-rose-50/40"
              >
                ดูหลักสูตร
              </Link>
            </div>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] lg:ml-4">
